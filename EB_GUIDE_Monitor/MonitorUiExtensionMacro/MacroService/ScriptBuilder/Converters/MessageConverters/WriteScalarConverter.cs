...
namespace MonitorUiExtensionMacro.MacroService.ScriptBuilder.Converters.MessageConverters
{
    ...
    internal class WriteScalarConverter : MessageConverterBase<WriteScalarValue>
    {
        ...
        public WriteScalarConverter(IModelService modelService, INamespaceService namespaceService, IModelValueConverter valueConverter)
        ...
        {
            var itemName = GetDatapoolItemFullName(valueMessage.DatapoolItemId);
