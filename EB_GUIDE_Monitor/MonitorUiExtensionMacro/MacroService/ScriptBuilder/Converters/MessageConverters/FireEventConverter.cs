...
namespace MonitorUiExtensionMacro.MacroService.ScriptBuilder.Converters.MessageConverters
{
    ...
    internal class FireEventConverter : MessageConverterBase<FireEvent>
    {
        ...
        public FireEventConverter(IModelService modelService, IModelValueConverter valueConverter)
        ...
        {
            var eventName = GetEventName(eventMessage.EventId, eventMessage.GroupId);
