...
namespace MonitorUiExtensionMacro.MacroService.ScriptBuilder.Converters.MessageConverters
{
    ...
    internal class InsertListItemConverter : MessageConverterBase<InsertListItem>
    {
        ...
        public InsertListItemConverter(IModelService modelService, INamespaceService namespaceService, IModelValueConverter valueConverter)
        ...
        {
            var itemName = GetDatapoolItemFullName(insertMessage.ItemId);
