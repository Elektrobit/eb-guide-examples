...
static gtf::dependencyresolver::InterfaceHandle createBufferSwapHooks(const gtf::dependencyresolver::DependencyContainerHandle&)
{
    return gtf::dependencyresolver::InterfaceHandle(new BufferSwapHooksExample());
}
...
GTF_PLUGIN_SO_SYMBOL void GTF_PLUGIN_EXTEND_CATALOG(void * catalog)
{
    ...
    gtf::dependencyresolver::extendCatalog<gtf::displayfactory::DisplayHooks, createBufferSwapHooks>(dependencyCatalog);
}
