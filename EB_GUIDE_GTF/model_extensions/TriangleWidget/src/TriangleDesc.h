...
#ifndef CUSTOM_WIDGET_TRIANGLE_DESC_H_INCLUDED
#define CUSTOM_WIDGET_TRIANGLE_DESC_H_INCLUDED
...
//!
class TriangleDesc : public gtf::metainformation::DescriptorProvider
{
public:
...
#endif // CUSTOM_WIDGET_TRIANGLE_DESC_H_INCLUDED
