...
#define TRIANGLE_PLUGIN_NAME "Triangle"
...
private:
    gtf::scdr::ShaderProgram* createShaderProgram(gtf::scdr::DataStore& dataStore_, gtf::scdr::CommandBuffer& commandBuffer_) const;
    gtf::scdr::ShaderProgram* createShaderProgramWithAlphaMask(gtf::scdr::DataStore& dataStore_, gtf::scdr::CommandBuffer& commandBuffer_) const;
