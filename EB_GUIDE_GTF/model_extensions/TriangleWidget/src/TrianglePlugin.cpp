...
{
    return gtf::dependencyresolver::InterfaceHandle(new trianglewidget::PreparedStageImpl(container));
}
...
{
    return gtf::dependencyresolver::InterfaceHandle(new trianglewidget::LoadedStageImpl(container));
}
