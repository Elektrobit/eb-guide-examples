...
gtf::scdr::RenderObject* GaussianBlur::createRenderObject(gtf::properties::Container& widget_, gtf::scdr::DataStore& dataStore_, gtf::scdr::CommandBuffer&, gtf::scdr::Allocator&)
{
    ...
    GaussianBlurRenderObject* object = ALLOC_OBJECT(allocator, GaussianBlurRenderObject, widget_, api, features.common2d, properties.common2d);

    if (object)
    {
        gtf::scdr::LoadHandle(widget_, properties.enabled, object->properties.enabled);
        gtf::scdr::LoadHandle(widget_, properties.sigma, object->properties.sigma);
    }
    ...
    gtf::scdr::TraverserContext&             traverserContext_)
{
    ...
    gtf::scdr::GetValue(object.properties.sigma, sigma);
