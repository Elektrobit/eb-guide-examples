...
GaussianBlur::GaussianBlur(const gtf::scene::TypeResolver& resolver_)
    ...
    , objects(nullptr)
{
    gtf::scdr::ResolvePropertiesCommon2D(resolver_, GaussianBlurDesc::WidgetName, properties.common2d);
    gtf::scdr::ResolveFeaturesCommon2D(resolver_, features.common2d);

    // clang-format off
    gtf::scene::TypeResolver::ContainerPropertyReference wpr[] = 
    {
        { { GaussianBlurDesc::WidgetName, gtf::properties::Container::Type() }, { "sigma"  , gtf::types::limits::uint16_max } },
        { { GaussianBlurDesc::WidgetName, gtf::properties::Container::Type() }, { "enabled", gtf::types::limits::uint16_max } }
    };
    // clang-format on
