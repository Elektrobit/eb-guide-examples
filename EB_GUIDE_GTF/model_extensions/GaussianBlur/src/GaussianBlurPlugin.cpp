...
{
    return gtf::dependencyresolver::InterfaceHandle(new gaussianblur::PreparedStageImpl(container));
}
...
{
    return gtf::dependencyresolver::InterfaceHandle(new gaussianblur::LoadedStageImpl(container));
}
