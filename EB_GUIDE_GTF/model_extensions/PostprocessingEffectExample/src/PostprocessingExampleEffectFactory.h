...
public:
    ...
    virtual void createEffectPasses(gtf::scdr::EffectPassArray& effectPasses_, gtf::properties::Container* widget_,
        const gtf::scdr::PostprocessingEffectParams& effectParams_, const gtf::scdr::SystemCapabilities& sysCaps_,
        gtf::scdr::FramebufferPool& framebufferPool_, gtf::scdr::CommandBuffer& commandBuffer_,
        gtf::scdr::Allocator& allocator_) const override;
