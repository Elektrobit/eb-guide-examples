...
#ifndef SCRIPT_FUNCTION_DESCRIPTOR_PROVIDER_H
#define SCRIPT_FUNCTION_DESCRIPTOR_PROVIDER_H
...
*/
class ScriptFunctionDescriptorProvider : public gtf::metainformation::DescriptorProvider
{
public:
...
#endif // SCRIPT_FUNCTION_DESCRIPTOR_PROVIDER_H
