...
public:
    ...
    {
        bool success = true;
        for (uint32_t propertyTypeIndex = 0; propertyTypeIndex < ARRAY_SIZE(BloomEffectWidgetProperties); ++propertyTypeIndex)
        {
            gtf::metainformation::PropertyDescriptor* curProperty = &(BloomEffectWidgetProperties[propertyTypeIndex]);
