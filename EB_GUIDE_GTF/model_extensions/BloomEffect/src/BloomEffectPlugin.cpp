...
{
    return gtf::dependencyresolver::InterfaceHandle(new bloom::PreparedStageImpl(container));
}
...
{
    return gtf::dependencyresolver::InterfaceHandle(new bloom::LoadedStageImpl(container));
}
