...
//! @brief Name: start_animation
//! @brief GroupName: Default
//! @brief Namespace : 
//!
//! Parameters: 0
#define LOCAL_EVENT_GRP_ID_START_ANIMATION LOCAL_EVENT_GROUP_DEFAULT
#define LOCAL_EVENT_MSG_ID_START_ANIMATION ((uint32_t) 0x00000001)
