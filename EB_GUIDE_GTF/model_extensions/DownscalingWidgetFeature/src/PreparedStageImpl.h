...
#ifndef DOWNSCALING_FEATURE_PREPARED_STAGE_IMPL_H
#define DOWNSCALING_FEATURE_PREPARED_STAGE_IMPL_H
...
namespace downscalingFeature
{
    ...
    private:
        ...
        gtf::metainformation::DescriptorProviderHandle featureDescriptor;
    };
}
#endif // DOWNSCALING_FEATURE_PREPARED_STAGE_IMPL_H
