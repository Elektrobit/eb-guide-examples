...
//! @brief Name: changeIntesity
//! @brief GroupName: Default
//! @brief Namespace : 
//!
//! Parameters: 0
#define LOCAL_EVENT_GRP_ID_CHANGEINTESITY LOCAL_EVENT_GROUP_DEFAULT
#define LOCAL_EVENT_MSG_ID_CHANGEINTESITY ((uint32_t) 0x00000001)
