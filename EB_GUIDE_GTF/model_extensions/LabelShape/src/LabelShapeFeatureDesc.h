...
#ifndef GTF_LABEL_SHAPE_WIDGET_FEATURE_DESC_H_INCLUDED
#define GTF_LABEL_SHAPE_WIDGET_FEATURE_DESC_H_INCLUDED

#include <gtf/metainformation/DescriptorProvider.h>

namespace labelshapewidgetfeature {
	class LabelShapeFeatureDesc : public gtf::metainformation::DescriptorProvider
	{
	public:
...
#endif // GTF_LABEL_SHAPE_WIDGET_FEATURE_DESC_H_INCLUDED
