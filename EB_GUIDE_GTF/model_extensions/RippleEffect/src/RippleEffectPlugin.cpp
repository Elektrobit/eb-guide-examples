...
{
    return gtf::dependencyresolver::InterfaceHandle(new rippleeffect::PreparedStageImpl(container));
}
...
{
    return gtf::dependencyresolver::InterfaceHandle(new rippleeffect::LoadedStageImpl(container));
}
