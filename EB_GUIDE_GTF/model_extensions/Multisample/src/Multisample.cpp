...
bool Renderer::init(const gtf::scene::TypeResolver&, gtf::scdr::DataStore& dataStore_, gtf::scdr::CommandBuffer& cmdBuffer_, gtf::scdr::Allocator&)
{
    ...
    success = success && createShaderConstants(offscreenProgram, program, programWithAlphaMask, gc, cmdBuffer_, graphicObjects.shaderConstants);
    ...
    gtf::scdr::TraverserContext&             tc_)
{
    ...
    // 3. Set up Multisampled framebuffer
    {
        int32_t sampleCount = 1;
        {
            ...
            gtf::scdr::GetValue(object.properties.sampleCount, sampleCountExp);
        ...
        gtf::scdr::GetValue(object.properties.animatedProperty, animatedProperty);
    }
    ...
    // 4. Update transforms and configure the draw object
    {
        ...
        gtf::scdr::GetValue(object.properties.fillColor, object.uniforms.offscreenPass.fillColor);
    ...
    gtf::scdr::Allocator&)
{
    ...
    MultisampleRenderObject* object = ALLOC_OBJECT(allocator, MultisampleRenderObject, widget_, features, properties.common2d);

    if (object)
    {
        gtf::scdr::LoadHandle(widget_, properties.fillColor, object->properties.fillColor);
        gtf::scdr::LoadHandle(widget_, properties.animatedProperty, object->properties.animatedProperty);
        gtf::scdr::LoadHandle(widget_, properties.sampleCount, object->properties.sampleCount);
    }
