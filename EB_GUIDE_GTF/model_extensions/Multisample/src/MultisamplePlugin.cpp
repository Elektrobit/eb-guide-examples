...
{
    return gtf::dependencyresolver::InterfaceHandle(new multisample::PreparedStageImpl(container));
}
...
{
    return gtf::dependencyresolver::InterfaceHandle(new multisample::LoadedStageImpl(container));
}
