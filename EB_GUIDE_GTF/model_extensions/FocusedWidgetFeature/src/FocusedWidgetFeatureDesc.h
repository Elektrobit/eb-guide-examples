...
#ifndef GTF_FOCUSED_WIDGET_FEATURE_DESC_H_INCLUDED
#define GTF_FOCUSED_WIDGET_FEATURE_DESC_H_INCLUDED
...
{
    class FocusedWidgetFeatureDesc : public gtf::metainformation::DescriptorProvider
    {
    public:
...
#endif // GTF_FOCUSED_WIDGET_FEATURE_DESC_H_INCLUDED
