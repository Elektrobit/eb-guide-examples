    ...
    gtf::scdr::TraverserContext&)
{
    ...
    if (!gtf::scdr::GetWidgetPropertiesCommon2DValues(object.properties.common2d, propertyValues))
    {
        return false;
    }

    // Get widget feature properties like translation, scaling, ... from the widget model
    gtf::scdr::GetWidgetFeaturesCommon2DValues(object.features.models, object.features.common2d, featureValues);
    ...
    gtf::scdr::Allocator&)
{
    ...
    return ALLOC_OBJECT(allocator, RenderObject, widget_, features, properties.common2d);
}
