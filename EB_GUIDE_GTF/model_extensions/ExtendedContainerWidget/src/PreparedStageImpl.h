...
#ifndef GTF_EXTENDED_CONTAINER_PREPARED_STAGE_IMPL_H_INCLUDED
#define GTF_EXTENDED_CONTAINER_PREPARED_STAGE_IMPL_H_INCLUDED
...
#endif // GTF_EXTENDED_CONTAINER_PREPARED_STAGE_IMPL_H_INCLUDED
