...
{
public:
    RenderObject(gtf::properties::Container& widget_, const gtf::scdr::WidgetFeaturesCommon2D& featureHandles_, const gtf::scdr::WidgetPropertiesCommon2D& propertyHandles_);
...
public:
    ...
    struct
    {
        gtf::scdr::WidgetPropertiesCommon2DHandles common2d;
    } properties;

    struct
    {
        gtf::scdr::WidgetFeaturesCommon2DModels  models;
        gtf::scdr::WidgetFeaturesCommon2DHandles common2d;
    } features;
};
} // namespace extendedcontainerwidget
