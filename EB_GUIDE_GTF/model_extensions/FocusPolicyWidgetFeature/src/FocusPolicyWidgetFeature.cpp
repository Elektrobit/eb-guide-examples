...
{
    model = &model_;
    observer->subscribe(model, this, gtf::utils::delegate::Delegate<void(const gtf::properties::ContainerHandle&, gtf::container::Array<gtf::properties::ContainerObserver::SubscriberNotificationData>&)>::create<FocusPolicyFeature, &FocusPolicyFeature::structureUpdate>(this));
}
...
void focusedpolicywidgetfeature::FocusPolicyFeature::structureUpdate(const gtf::properties::ContainerHandle&, gtf::container::Array<gtf::properties::ContainerObserver::SubscriberNotificationData>&) 
{
