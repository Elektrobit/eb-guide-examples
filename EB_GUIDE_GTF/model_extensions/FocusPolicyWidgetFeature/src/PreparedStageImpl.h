...
#ifndef GTF_FOCUSED_POLICY_WIDGET_FEATURE_PREPARED_STAGE_IMPL_H_INCLUDED
#define GTF_FOCUSED_POLICY_WIDGET_FEATURE_PREPARED_STAGE_IMPL_H_INCLUDED
...
#endif // GTF_FOCUSED_POLICY_WIDGET_FEATURE_PREPARED_STAGE_IMPL_H_INCLUDED
