...
//!
//! Parameters: 0
#define LOCAL_EVENT_GRP_ID_BACK LOCAL_EVENT_GROUP_DEFAULT
#define LOCAL_EVENT_MSG_ID_BACK ((uint32_t) 0x00000003)
...
#define LOCAL_EVENT_MSG_ID_NEXT ((uint32_t) 0x00000004)
