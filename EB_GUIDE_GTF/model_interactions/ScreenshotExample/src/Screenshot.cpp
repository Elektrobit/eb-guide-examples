...
void Screenshot::updateScene(uint32_t sceneId_, gtf::scenecapture::Bitmap const& bitmap)
{
    ...
    flipImage(bitmap);
    writeTGA(filePath.c_str(), bitmap.width, bitmap.height, bitmap.bytesPerPixel(), buffer.getData());
